...
CGO_ENABLED=1 GOOS=darwin GOARCH=amd64 CC=o64-clang CXX=o64-clang++ go build -ldflags="-s -w" -o ../src/main/resources/darwin-x86_64/goleveldb.dylib -buildmode=c-shared ./main.go